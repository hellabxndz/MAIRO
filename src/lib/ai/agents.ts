...
export const AGENT_DESCRIPTIONS: Record<AgentType, string> = {
  ...
  SUPPORT: "Questions about your account, plan, or how MyRo works.",
  OWNER_COPILOT: "Internal copilot across every MyRo client account.",
};

const BASE_CONTEXT = `You are part of MyRo, a platform that runs Meta (Facebook/Instagram) ad
campaigns on behalf of small business owners who are not ad experts. Business owners
set a goal and monthly budget, and MyRo's team and AI agents plan, create, and manage
...
noted it and that the MyRo team will apply it, or point them to the Campaigns page.`;
    case "CREATIVE":
      return `${BASE_CONTEXT}
...
You are the Support agent. You answer questions about how MyRo works, the business's
...
you're flagging it for the MyRo team.`;
    case "OWNER_COPILOT":
      return `You are the AIOS copilot for MyRo's owner/operator. You help the owner manage
