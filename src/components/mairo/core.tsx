  ...
  return (
    <div className={`relative ${className}`} aria-hidden>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(61,125,255,0.34), rgba(61,125,255,0.10) 46%, transparent 74%)",
        }}
      />
      ...
      <svg viewBox="0 0 300 300" className="relative w-full" role="presentation">
        <defs>
          <radialGradient id="mairo-globe" cx="42%" cy="36%" r="72%">
            ...
            <stop offset="45%" stopColor="#2f6dff" stopOpacity="0.30" />
            <stop offset="100%" stopColor="#0a1638" stopOpacity="0.85" />
          </radialGradient>
          <linearGradient id="mairo-ring" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#6aa6ff" stopOpacity="0.05" />
            <stop offset="35%" stopColor="#6aa6ff" stopOpacity="0.85" />
            <stop offset="65%" stopColor="#a78bfa" stopOpacity="0.75" />
            <stop offset="100%" stopColor="#6aa6ff" stopOpacity="0.05" />
          </linearGradient>
          <linearGradient id="mairo-wire" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#9cc4ff" stopOpacity="0.5" />
            <stop offset="100%" stopColor="#4b7dff" stopOpacity="0.14" />
          </linearGradient>
        ...
        <g className="mairo-orbit mairo-orbit-1" style={{ transformOrigin: "150px 150px" }}>
          <ellipse cx="150" cy="150" rx="132" ry="46" fill="none" stroke="url(#mairo-ring)" strokeWidth="1.1" />
        </g>
        <g className="mairo-orbit mairo-orbit-2" style={{ transformOrigin: "150px 150px" }}>
          <ellipse cx="150" cy="150" rx="46" ry="132" fill="none" stroke="url(#mairo-ring)" strokeWidth="1.1" />
        </g>
        <g className="mairo-orbit mairo-orbit-3" style={{ transformOrigin: "150px 150px" }}>
          <ellipse cx="150" cy="150" rx="124" ry="98" fill="none" stroke="url(#mairo-ring)" strokeWidth="0.9" />
        </g>

        {/* ---- The globe ---- */}
        <circle cx="150" cy="150" r="88" fill="url(#mairo-globe)" />
        <g clipPath="url(#mairo-sphere)" stroke="url(#mairo-wire)" fill="none" strokeWidth="0.7">
          {/* Latitudes */}
        ...
        <circle cx="150" cy="150" r="88" fill="none" stroke="#9cc4ff" strokeOpacity="0.45" strokeWidth="1" />
        <circle cx="150" cy="150" r="88" fill="none" stroke="#3d7dff" strokeOpacity="0.5" strokeWidth="3" className="mairo-breathe" style={{ transformOrigin: "150px 150px" }} />
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center pb-[10%]">
        <p className="text-[clamp(20px,4.6vw,34px)] font-light tracking-[0.36em] text-white">
          MAIRO
        </p>
        <p className="mt-2 max-w-[54%] text-center font-mono text-[7px] uppercase leading-[2] tracking-[0.3em] text-blue-bright/70 sm:text-[9px]">
          Intelligence turns
          <br />
      ...
      <style>{`
        ...
        @media (prefers-reduced-motion: reduce) {
          .mairo-orbit, .mairo-breathe, .mairo-node { animation: none; }
        }
      `}</style>
    </div>
  );
